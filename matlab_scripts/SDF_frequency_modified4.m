...
n1 = datenum(2013,10,01);
n2 = datenum(2013,12,31);
            ...
            for jj = 1:24
                ...
                if B1.(fields1{1})(:,:,jj) == 0 | B2.(fields2{1})(:,:,jj) == 0 | B3.(fields3{1})(:,:,jj) == 0
                    ...
                    if B1.(fields1{1})(:,:,jj) == 0
                        count5 = count5 + 1;
                        Zeros_layer{count5} = strcat('T10_',datestr(n,'yyyymmdd'),'_P',num2str(m),'_layer',num2str(jj),'.mat');
                    end
                    if B2.(fields2{1})(:,:,jj) == 0
                        count5 = count5 + 1;
                        Zeros_layer{count5} = strcat('T09_',datestr(n,'yyyymmdd'),'_P',num2str(m),'_layer',num2str(jj),'.mat');
                    end
                    if B3.(fields3{1})(:,:,jj) == 0
                        count5 = count5 + 1;
                        Zeros_layer{count5} = strcat('T07_',datestr(n,'yyyymmdd'),'_P',num2str(m),'_layer',num2str(jj),'.mat');
                    end
                    continue
                else
...
save ('Dust_daily_SDF_2013_10to12_final','Dust_daily_each_time_step','-v7.3')
save ('Dust_SDF_frequency_2013_10to12_final','Dust_daily_sum','-v7.3')
save ('Dust_SDF_frequency_raster_2013_10to12_final','Dust_monthly')
save ('Missing_layer_counter_2013_10to12_final','Missing_layer_counter')
save ('Missing_file_2013_10to12_final','Missing_file')
save ('Missing_index_2013_10to12_final','Missing_index')
save ('Zeros_layer_2013_10to12_final','Zeros_layer')