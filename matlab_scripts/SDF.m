...
for t = 17:31
    count = 0;
    for k = 1:4
        A1=load(strcat('\\10.106.67.26\matlab-data\EUMETSAT\T07\T07_201212',num2str(t),'_P',num2str(k),'.mat'));
        A2=load(strcat('\\10.106.67.26\matlab-data\EUMETSAT\T09\T09_201212',num2str(t),'_P',num2str(k),'.mat'));
...
load \\10.106.67.26\matlab-data\EUMETSAT\T10\T10_20130101_P3;
