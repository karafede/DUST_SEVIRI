...
for n = n1:n2
    ...
    checkfileB1 = exist(['\\10.106.67.26\matlab-data\Archive_MCIDAS\MCIDAS\',datestr(n,'yyyy'),'\',sprintf('%.3d',count),'\T10',sprintf('%.3d',count),'.mat'],'file');
    checkfileB2 = exist(['\\10.106.67.26\matlab-data\Archive_MCIDAS\MCIDAS\',datestr(n,'yyyy'),'\',sprintf('%.3d',count),'\T09',sprintf('%.3d',count),'.mat'],'file');
    checkfileB3 = exist(['\\10.106.67.26\matlab-data\Archive_MCIDAS\MCIDAS\',datestr(n,'yyyy'),'\',sprintf('%.3d',count),'\T07',sprintf('%.3d',count),'.mat'],'file');
...
save ('Dust_SDF_frequency_2004_4_end','Dust_daily_sum','-v7.3')
save ('Dust_SDF_frequency_raster_2004_4_end','Dust_raster')