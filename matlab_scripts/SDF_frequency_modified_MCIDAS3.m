    ...
    try
        for jj = 1:61
            ...
            if B11 == 0 | B22 == 0 | B33 == 0
                ...
                if B11 == 0
                    count3 = count3 + 1;
                    Zeros_layer{count3} = strcat('T10_',datestr(n,'yyyy'),'_',sprintf('%.3d',n-n3+1),'_layer',num2str(jj),'.mat');
                end
                if B22 == 0
                    count3 = count3 + 1;
                    Zeros_layer{count3} = strcat('T09_',datestr(n,'yyyy'),'_',sprintf('%.3d',n-n3+1),'_layer',num2str(jj),'.mat');
                end
                if B33 == 0
                    count3 = count3 + 1;
                    Zeros_layer{count3} = strcat('T07_',datestr(n,'yyyy'),'_',sprintf('%.3d',n-n3+1),'_layer',num2str(jj),'.mat');
                end
                continue
            else
                BT108 = B22;
...
save ('Dust_daily_SDF_McIDAS_2004_5_final','Dust_daily_each_time_step','-v7.3')
save ('Dust_SDF_frequency_McIDAS_2004_5_final','Dust_daily_sum','-v7.3')
save ('Dust_SDF_frequency_raster_McIDAS_2004_5_final','Dust_monthly')
save ('Missing_layer_counter_McIDAS_2004_5_final','Missing_layer_counter')
save ('Missing_file_2004_McIDAS_5_final','Missing_file')
save ('Missing_index_2004_McIDAS_5_final','Missing_index')